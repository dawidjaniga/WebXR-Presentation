...
import { Deck, Slide, Text, Appear, Image } from 'spectacle'
  ...
  return (
    <Main>
      ...
      >
        ...
        <Slide transition={['slide', 'fade']}>
          ...
          <List>
            <Appear>
              <div>
                <ListItem>
                  Technologią do tworzenie wirtualnej rzeczywistości w
        ...
        <Slide>
          <Heading size={2}>Historia</Heading>
          <List>
            <Appear>
              <div>
                <ListItem>
        ...
        <Slide>
          <Heading size={2}>WebVR i WebGL</Heading>
          <Magnifier
        ...
        <Slide>
          <Heading size={2}>Współpraca niezależnie od urządzeń</Heading>
          <Video
            width='100%'
            src={videos.easyCollaboration}
            controls
            autoPlay={false}
            muted={false}
          />
        ...
        <List>
          ...
          <List>
            <ListItem>
              Polyfill - proteza dla przeglądarek bez wbudowanej funkcjonalności
            </ListItem>
        ...
        <Slide>
          <Heading size={2}>Gamepad API</Heading>
          <Video
            width='100%'
            src={videos.gamepadApi}
            controls
            autoPlay={false}
            muted
          />
        ...
        <Slide>
          ...
          <List>
            ...
            <ListItem>
              przedstawienie w szczegółach jak zbudowana jest Mapa Wikipedii
            </ListItem>
          </List>
        </Slide>
        <Slide>
        ...
        <Slide id='thank-you'>
          ...
          <Button href='https://twitter.com/dawidjaniga'>
            {/* <InlineImage src={images.twitter} height='2em' /> dawidjaniga */}
          </Button>
          <Text margin='40px'>
